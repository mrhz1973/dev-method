...
| Executing or handoff PM-51 at home (runbook, matrix, new chat) | `docs/control-plane/pm-51-runbook-light.md`, `docs/control-plane/pm-51-decision-matrix.md`, `docs/control-plane/pm-51-new-chat-handoff-checklist.md` |
