...
- Clarified that implementers perform routine safe local repo update during preflight for any target repo; humans are only asked for update output when a diagnostic gate exists.
